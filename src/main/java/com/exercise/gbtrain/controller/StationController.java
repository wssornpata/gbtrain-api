...
public class StationController {
    ...
    @GetMapping("/traincolor")
    public ResponseEntity<Object> getStationByTrainColor(@RequestBody TrainStationRequest trainStationRequest) {
        var response = stationService.getStationListByTrainColor(trainStationRequest);
        return ResponseEntity.status(HttpStatus.OK).body(response);
    }
}
